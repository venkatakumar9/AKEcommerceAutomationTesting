...
namespace AKEcommerceAutomation
{
    ...
    sealed class DestinationpageSteps : SeleniumTestBase
    {
        ...
        {
            _homePage.GetDestinationsPage();
        }
      
        [Then(@"I reach the destination page")]
        public void ThenIReachTheDestinationPage()
        {
            var title = _homePage.GetDestinationsPage().title();
        ...
        {
           _homePage = new HomePage(driver);
           var title = _homePage.GetDestinationsPage().vectormapclick_Americas();
        }
        ...
        {
            _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_Africa();
        }
        ...
        {
            _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_Europe();
        }
        ...
        {
            _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_Carribean();
        }
        ...
        {
            _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_AutraliaAndNewzealand();
        }
        ...
        {
            _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_Middleeast();
        }
        ...
        {
            _homePage = new HomePage(driver);
          string title =  _homePage.GetDestinationsPage().vectormapclick_IndiaAndHimalayas();
        }
        ...
        {
            _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_IndianOcean();
        }
        ...
        {
             _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_Arctic();
        }
        ...
        {
            _homePage = new HomePage(driver);
            string title = _homePage.GetDestinationsPage().vectormapclick_Antarctica();
        }
